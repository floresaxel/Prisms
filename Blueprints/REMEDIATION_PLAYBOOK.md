...
| R2 status semantics | 1 | — | ✅ merged `05a3bc6` (2026-07-02; core 547 + coverage 90.49/93.4/93.58, server 115, convergence 14/14, turbo 21/21; red→green pinned via scenario 13b) |
| R3 hours correctness | 1 | — | ✅ `3a243c9` |
...
| R7 StatusIndex client | 2 | R2 (status-index.ts order) | ✅ `d8eaecc` (2026-07-02; S8-F1 incremental provider + S2-F4/F5; core 557 cov 90.34/93.99/93.26, ui 82, web 7 + build, turbo 21/21) |
| R8 server scale+effects | 3 | R2, R4, R6 | ✅ `63c284e` (2026-07-02; S4-F2 per-batch context cache — 20 edge.creates/100k 22.2s→1.26s = 17.6× — + S4-F3 command_log.effects; server 125/125, turbo 21/21; stretch S4-F7/A2 deferred) |
